...
from briefing_bots.storage import latest_articles_by_keyword, upsert_articles


async def build_channel_digest(database_path, channel: dict, max_items: int, max_chars: int, model: str) -> str:
    ...
    grouped_articles = {
        keyword: await latest_articles_by_keyword(database_path, keyword, max_items)
